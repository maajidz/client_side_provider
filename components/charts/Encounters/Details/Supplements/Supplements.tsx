                                        ...
                                        <FormItem className='flex gap-2 items-center'>
                                            ...
                                            <FormControl>
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    ...
                                                    <SelectContent>
                                                        <SelectItem value="intake_type1">Intake type 1</SelectItem>
                                                        <SelectItem value="intake_type2">Intake type 2</SelectItem>
                                                        <SelectItem value="intake_type3">Intake type 3</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            </FormControl>
                                            <FormMessage />
