                                        ...
                                        <FormItem className='w-full'>
                                            <FormControl>
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    ...
                                                    <SelectContent>
                                                        <SelectItem value="diagnosis1">Diagnosis 1</SelectItem>
                                                        <SelectItem value="diagnosis2">Diagnosis 2</SelectItem>
                                                        <SelectItem value="diagnosis3">Diagnosis 3</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            </FormControl>
                                            <FormMessage />
                            ...
                            <div className='flex gap-3 items-center'>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <Input type='number' placeholder="Quantity" {...field} className='w-28' onChange={(e) => field.onChange(e.target.valueAsNumber || '')} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='flex gap-2 items-center'>
                                            ...
                                            <FormControl>
                                                <Input type='number' placeholder='' {...field} onChange={(e) => field.onChange(e.target.valueAsNumber || '')} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='flex gap-3 items-center'>
                                            <FormLabel className='w-fit'>Earliest Fill Date</FormLabel>
                                            <FormControl>
