                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex flex-col gap-6'>
                        <div>
                            ...
                            <div className='font-medium text-base'>{response?.data.firstName}</div>
                        </div>
                        <div>
                            <div className='font-normal text-sm'>Last Name</div>
                            <div className='font-medium text-base'>{response?.data.lastName}</div>
                        </div>
                        <div className='flex flex-col'>
                            <div className='font-normal text-sm'>DOB | Age</div>
                            <div className='font-medium text-base'>{formatDate(response?.data.userDetails.dob, { year: 'numeric', month: '2-digit', day: '2-digit' })} | years</div>
                        </div>
                        <div>
                            <div className='font-normal text-sm'>Birth Sex</div>
                            <div className='font-medium text-base'>{response?.data.userDetails.gender}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex flex-col gap-6'>
                        <div>
                            ...
                            <div className='font-medium text-base'>{response?.data.userDetails.location}</div>
                        </div>
                        <div>
                            <div className='font-normal text-sm'>Cell Phone</div>
                            <div className='font-medium text-base'>{response?.data.phoneNumber}</div>
                        </div>
                        <div>
                            <div className='font-normal text-sm'>Email</div>
                            <div className='font-medium text-base'>{response?.data.email}</div>
                        </div>
                    </div>
                </div>
            </div>
