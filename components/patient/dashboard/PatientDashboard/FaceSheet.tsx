                  ...
                  <CardContent className="flex flex-row gap-2 w-full">
                    {userDashboardData?.diagnoses ? (
                      ...
                      >
                        ...
                        <div
                          className={`${styles.infoSub} flex w-fit flex-shrink-0 pt-1`}
                        >
                          {new Date(
                        ...
                        {userDashboardData?.familyHistory ? (
                          ...
                          >
                            ...
                            <FaceSheetLabels
                              ...
                              value={
                                userDashboardData?.familyHistory?.relationship
                              }
                            />
                            <FaceSheetLabels
                              label="Age:"
                          ...
                          >
                            ...
                            <div
                              ...
                              dangerouslySetInnerHTML={{
                                __html:
                                  userDashboardData?.socialHistories?.content,
                              }}
                            />
                          </div>
                        ) : (
                  ...
                  <CardContent className="flex flex-row gap-2">
                    {userDashboardData?.supplements ? (
                      ...
                      >
                        <div className={`${styles.infoTextLabel}`}>
                          {
                            userDashboardData?.supplements?.type
                              ?.supplement_name
                          }{" "}
                          {" - "}
                ...
                <Card className="flex flex-1">
                  ...
                  <CardContent className="flex flex-row gap-2">
                    {userDashboardData?.labResults ? (
                      ...
                      >
                        <div className={`${styles.infoTextLabel}`}>
                          {userDashboardData?.labResults?.files?.map(
                            (image) => (
                              <Button
                                className="p-0"
                                key={image}
                ...
                <Card className="flex flex-1">
                  ...
                  <CardContent className="flex flex-row gap-2">
                    {userDashboardData?.documents ? (
                      ...
                      >
                        <div className={`${styles.infoTextLabel}`}>
                          {userDashboardData?.documents?.documents.map(
                            (image) => (
                              <Button
                                key={image}
                                className="p-0"
